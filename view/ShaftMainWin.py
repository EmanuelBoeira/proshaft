...
class ShaftMainWindow:
	...
	def DrawOrientationCanvas(self):
		self.canvas_axial.create_line(((240,240),(240,220)), fill='black', width=1)
		self.canvas_axial.create_line(((240,240),(220,240)), fill='black', width=1)
		self.canvas_axial.create_polygon(((235,220),(240,210),(245,220)),fill='black')
		self.canvas_axial.create_polygon(((220,235),(210,240),(220,245)),fill='black')
		self.canvas_axial.create_text((200, 240), text='z', fill='black', font='tkDefaultFont 10')
		self.canvas_axial.create_text((240, 200), text='y', fill='black', font='tkDefaultFont 10')
